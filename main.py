...
back = (99, 150, 113) #цвет фона (background) 
...
'''класс надпись''' 
class Label(Area): 
  def set_text(self, text, fsize=12, text_color=(189, 139, 40)): 
...
GREEN = (60, 189, 84) 
YELLOW = (230, 219, 195) 
DARK_BLUE = (252, 252, 252) 
BLUE = (217, 194, 145) 
LIGHT_GREEN = (16, 194, 108) 
